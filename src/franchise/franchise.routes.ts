...
import {findAll, findOne, add, update, remove,  sanitizeInput, sanitizePartialInput, validateExists} from "./franchise.controller.js";
...
franchiseRouter.patch("/:id", validateExists, sanitizePartialInput, update);
