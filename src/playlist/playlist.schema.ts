...
const ERR_BAD_NAME =
  'Invalid characters in playlist name. It can contain alphanumeric characters, spaces, and common punctuation.';
...
const ERR_BAD_DESC =
  'Invalid characters in playlist description. It can contain alphanumeric characters, spaces, and common punctuation.';
...
const description = v.pipe(
  ...
  v.regex(/^[a-zA-Z0-9\s.,!?;:()\-]+$/, ERR_BAD_DESC) // Matches a-z, A-Z, 0-9, spaces, and common punctuation
);
